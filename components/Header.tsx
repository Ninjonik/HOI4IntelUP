                ...
                <div className="container">
                    ...
                    <div className="navbar-collapse collapse" id="navbar_global">
                                    ...
                                    <div className="dropdown-menu-inner">
                                        <a href="https://demos.creative-tim.com/argon-design-system/docs/getting-started/overview.html" className="media d-flex align-items-center">
                                            ...
                                            <div className="media-body ml-3">
                                                ...
                                                <div className="description d-none d-md-inline-block mb-0">Learn how to use compiling Scss, change brand colors and more.</div>
                                            </div>
                                        </a>
                                        <a href="https://demos.creative-tim.com/argon-design-system/docs/foundation/colors.html" className="media d-flex align-items-center">
                                            ...
                                            <div className="media-body ml-3">
                                                ...
                                                <div className="description d-none d-md-inline-block mb-0">Learn more about colors, typography, icons and the grid system we used for .</div>
                                            </div>
                                        </a>
                                        <a href="https://demos.creative-tim.com/argon-design-system/docs/components/alerts.html" className="media d-flex align-items-center">
                                            ...
                                            <div className="media-body ml-3">
                                                ...
                                                <div className="description d-none d-md-inline-block mb-0">Browse our 50 beautiful handcrafted components offered in the Free version.</div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <ul className="navbar-nav align-items-lg-center ml-lg-auto">
                            ...
                            <li className="nav-item">
                                <a className="btn btn-neutral" href="https://www.creative-tim.com/builder/argon" target="_blank">
                                    <span className="nav-link-inner--text">Online Builder</span>
                                </a>
                            </li>
